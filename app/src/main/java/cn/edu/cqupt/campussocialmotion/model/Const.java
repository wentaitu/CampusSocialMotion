...
public interface Const {
    ...
    public static final String BASE_GET_ACTIVITY = "http://120.78.190.56:8080/";                      // (新)
    public static final String GET_ACTIVITY = "sports-dating/activity/getActivities";                 // 获取活动信息
    public static final String POST_ACTIVITY = "Sports/api/activity/createActivity";                  // 上传活动信息(新)
